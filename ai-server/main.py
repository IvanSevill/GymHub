...
from models import ChatMessage, ChatMemory, Goal, NutritionLog, MoodEnergyLog  # noqa: E402, F401 — ensure tables are registered
...
Base.metadata.create_all(bind=engine, tables=[
    ...
    Base.metadata.tables["nutrition_logs"],
    Base.metadata.tables["mood_energy_logs"],
])
